...
with col1:
    st.image("Coat_of_arms_of_Kenya_Official.svg", width=100)  # Replace with your first image path or URL
with col2:
    st.image("Emblem_of_East_African_Community.svg", width=100)  # Replace with your second image path or URL
with col3:
    st.image("kra-seeklogo-3.jpeg", width=100)  # Replace with your third image path or URL
with col4:
